...
import controller.front.ListeUtilisateursController;
import controller.front.SeconnecterController;
...
public class AjouterAdminController {   private final UtilisateurService us = new UtilisateurService();
    ...
    public void navigatetoLogin(ActionEvent actionEvent) {
        ...
        SeconnecterAdminController lu = loader.getController();
        nomUserTF.getScene().setRoot(root);
    }
}
